    ...
    return(
        <div className="browser-container">
            ...
            <div className="content-body">
                <BrowserSelections selection={selection} setSelection={setSelection} page={page} snippets={snippets}/>
                <BrowserDisplay selection={selection} page={page} favorites={favorites} setTriggerUpdateFavorites={setTriggerUpdateFavorites} />
            </div>
            <Footer/>
        </div>
    )
